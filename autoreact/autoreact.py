...
class Autoreact(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        # sticker permissions 
        if lv10 or booster or srvstaff or chatmem or voicemem or trial or admin or ytmem or minecraftstaff or minecraftdev or verified or rankholder in message.author.roles and message.stickers:
            return
        else:
