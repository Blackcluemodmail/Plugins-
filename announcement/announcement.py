...
plain_session = "Click the `Edit` button below to set/edit the content.\n"
mention_session = (
...
class Announcement(commands.Cog):
    ...
    @commands.command(
        help=(
            "Publish a message from announcement channel to all servers that have followed the channel.\n\n"
